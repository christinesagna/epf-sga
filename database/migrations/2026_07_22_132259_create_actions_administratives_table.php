...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('actions_administratives', function (Blueprint $table) {
            ...
            $table->foreignId('utilisateur_cible_id')->nullable()->constrained('users')->restrictOnDelete();
            $table->string('cible_type')->nullable()->index();
            $table->unsignedBigInteger('cible_id')->nullable()->index();
